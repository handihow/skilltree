...
export class JoinQuiz extends Component<IJoinQuizProps,IJoinQuizState> {
    ...
    render() {
        ...
        return (
            ...
            <p>Go to the skilltree editor and then the skill editor. You will find a button there to add a quiz to the skill.</p>
            <p>Once the quiz is added to the skill, a button to enter the quiz will appear in the skill of your skilltree.</p>
            ...
            <p className="has-text-weight-bold">https://easyskilltree.com/quizzes/{this.state.quiz?.id}/test</p>
