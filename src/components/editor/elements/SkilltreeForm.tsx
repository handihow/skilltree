        ...
        <div className="modal-card">
          <header className="modal-card-head">
            <p className="modal-card-title">
              {this.props.isEditing ? "Edit skilltree" : "Add skilltree"}
            </p>
            <button
              className="delete"
              aria-label="close"
          ...
          <form onSubmit={this.onSubmit}>
            <section className="modal-card-body">
              ...
              {!this.props.isEditing && this.state.moreOptions && (
                <div className="field box p-1">
                    ...
                    <div className="field">
                      <label className="checkbox" htmlFor="collapsible">
                        <input
                          type="checkbox"
                          name="collapsible"
                          onChange={this.handleCollapsibleChange}
