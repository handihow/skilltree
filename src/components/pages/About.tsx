...
export default function About() {
    return (
        ...
        <section className="section">
            ...
            <div className="content">
                <p>
                    SkillTree is an open source project maintained by HandiHow - Education Developers. </p>
                <p>You can view documentation on how to use the application on the <a href="https://github.com/handihow/skilltree/wiki" 
                    target="_blank"
                    rel="noopener noreferrer">wiki pages</a>.</p>
                <p>
